...
fun SampleScreen(viewModel: SampleViewModel) {
	...
	Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
		Column(
			...
			OutputComponent(
				writtenText = uiState.outputState.outputText,
				backgroundColor = uiState.outputState.backgroundColor
			)
			ColorPickerComponent(
				backgroundColor = uiState.colorPickerState.backgroundColor,
				onSignal = viewModel::processSignal,
				selectedColorIndex = uiState.colorPickerState.selectedColorIndex
			)
			MultiOutputComponent(
				writtenText = uiState.multiOutputState.writtenUppercaseText,
				selectedColor = uiState.multiOutputState.selectedColor,
				backgroundColor = uiState.multiOutputState.backgroundColor
			)
